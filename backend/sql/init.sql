...
CREATE TABLE `course` (
    ...
    `credits` FLOAT NOT NULL DEFAULT 0 COMMENT '学分',
    `open_depart` VARCHAR(32) NOT NULL COMMENT '开课学院',
    `exam_mod` VARCHAR(32) NOT NULL COMMENT '考核方式',
    `campus` VARCHAR(32) NOT NULL COMMENT '校区',
    ...
    `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `update_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `semester_code` INT NOT NULL DEFAULT 0 COMMENT '学期代码',
    PRIMARY KEY (`id`),
